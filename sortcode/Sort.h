...
class Sortcode {
 ...
 public :
  ...
  // An array of hits in the upstream detector only
  Double_t UpEnergy[MAXSILICON];
  Double_t UpTheta[MAXSILICON];
  Double_t UpEx[MAXSILICON];
  Int_t UpMult;
  ...
  Float_t edop_maxInt[MAXGRETINA];
